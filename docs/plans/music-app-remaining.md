...
3. **Complete Image Scanning Flow** - Implement OMR scanning integration
   ...
   - Integrate with backend OMR service (or create mock for demo)
...
- [ ] "Scan Music" button opens camera/file picker and processes image
...
### Depends On
- None (this builds on existing UI structure)
...
### Depends On
- Task 1 (Library Module - for score selection)
